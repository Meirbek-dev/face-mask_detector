...
parser.add_argument(
    "-l", "--labels_path", help="Путь к файлу с метками .pbtxt.", type=str
)
parser.add_argument(
    "-o",
    "--output_path",
...
parser.add_argument(
    "-c",
    "--csv_path",
    help="Путь к файлу .csv. Если не указан, то не будет записан",
    type=str,
    default=None,
)
...
def main(_):
    ...
    if args.csv_path is not None:
        ...
        print("Файл CSV успешно создан: {}".format(args.csv_path))
